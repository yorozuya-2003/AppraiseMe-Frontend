# Generated by Django 4.2.1 on 2023-12-11 17:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Email', models.EmailField(default='vv@gmail.com', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downvotes', models.ManyToManyField(blank=True, related_name='downvoted_reviews', to='main.profiles')),
                ('upvotes', models.ManyToManyField(blank=True, related_name='upvoted_reviews', to='main.profiles')),
            ],
            options={
